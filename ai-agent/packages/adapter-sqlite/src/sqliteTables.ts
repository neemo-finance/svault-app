...
-- Custom table for Neemo plugin history
CREATE TABLE IF NOT EXISTS yield_log (
  timestamp INTEGER PRIMARY KEY, -- Use INTEGER PRIMARY KEY for auto-increment behavior in SQLite
  log_entry TEXT NOT NULL,
  readable_log_entry TEXT, -- New column for AI-generated summary
  tag TEXT -- New column for log category/tag
);
